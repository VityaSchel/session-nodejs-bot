...
function getContactsToRemoveFromDB(contactsInWrapper: Array<ContactInfo>) {
  ...
  const currentlySelectedConversationId = undefined//getCurrentlySelectedConversationOutsideRedux();
  const currentlySelectedConvo: ConversationModel | undefined = /*currentlySelectedConversationId
